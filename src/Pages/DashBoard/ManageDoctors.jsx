...
const ManageDoctors = () => {
    ...
    queryFn: async () => {
      try {
        const res = await fetch(
          "https://doctors-portal-server-liart.vercel.app/doctors",
          {
            headers: {
  ...
  const handleDeleteDoctor = (doctor) => {
    // console.log(id);
    fetch(
      `https://doctors-portal-server-liart.vercel.app/doctors/${doctor._id}`,
      {
        method: "delete",
        headers: {
          authorization: `bearer ${localStorage.getItem("accessToken")}`,
              ...
              <tr key={doctor._id}>
                ...
                <th>
                  <label
                    ...
                    className="btn btn-primary bg-red-600 text-white btn-xs"
                  >
                    DELETE
                  </label>
                </th>
